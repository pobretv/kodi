...
__PASTA_TRAKT__ = os.path.join(xbmcvfs.translatePath('special://userdata/addon_data/plugin.video.pobretv/trakt/'))
__DB_FILE__ = os.path.join(xbmcvfs.translatePath('special://userdata/addon_data/plugin.video.pobretv/'), 'trakt.db')
__PROGRESSO_FILE__ = os.path.join(__PASTA_TRAKT__, 'progresso.pobretv')
__WATCH_FILMES_FILE__ = os.path.join(__PASTA_TRAKT__, 'watch_filmes.pobretv')
__WATCH_SERIES_FILE__ = os.path.join(__PASTA_TRAKT__, 'watch_series.pobretv')
__FILMES_FILE__ = os.path.join(__PASTA_TRAKT__, 'filmes.pobretv')
__SERIES_FILE__ = os.path.join(__PASTA_TRAKT__, 'series.pobretv')

__CACHE_FILE__ = os.path.join(xbmcvfs.translatePath('special://userdata/addon_data/plugin.video.pobretv/'), 'dadosv1.db')
